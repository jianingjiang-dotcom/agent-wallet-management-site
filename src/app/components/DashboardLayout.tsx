...
export default function DashboardLayout() {
  ...
  const LogoText = () => (
    <svg width="140" height="24" viewBox="0 0 312 54" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={`relative transition-[border-color] duration-300 ease-in-out ${sidebarCollapsed ? 'border-t border-transparent' : 'border-t border-[#EBEBEB]'}`} ref={accountMenuRef}>
          ...
          >
            <div className={`shrink-0 flex items-center justify-center ${sidebarCollapsed ? 'hover:bg-[#F0F2FF] transition-colors rounded-[8px]' : ''}`}>
              <div className="w-[36px] h-[36px] rounded-full bg-[#4F5EFF] flex items-center justify-center shrink-0">
          ...
          {mobileSettingsPage ? (
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-5 pt-3 pb-8">
                ...
                >
                  <span className={`text-[14px] lg:text-[15px] ${language === 'en' ? 'font-medium text-[#0A0A0A]' : 'font-normal text-[#7C7C7C]'}`}>English</span>
                  {language === 'en' && (
                ...
                <button
                  ...
                  className="flex items-center justify-between w-full py-3.5 px-1 transition-colors hover:bg-[#F0F2FF] rounded-lg"
                >
                  <span className={`text-[14px] lg:text-[15px] ${language === 'zh' ? 'font-medium text-[#0A0A0A]' : 'font-normal text-[#7C7C7C]'}`}>中文</span>
                  {language === 'zh' && (
                    <Check className="w-4 h-4 text-[#1F32D6]" strokeWidth={2.5} />
                  )}
                </button>
