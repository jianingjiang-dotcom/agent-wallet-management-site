        ...
        <div className={`w-full max-w-[520px] ${animClass}`} key={step}>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full max-w-[420px] mb-4">
                <input
                  ...
                  maxLength={9}
                  className={`w-full h-[52px] bg-[var(--app-card-bg)] border rounded-[12px] px-4 font-['Inter',sans-serif] text-[15px] text-[#0a0a0a] text-center placeholder:text-[#c0c0c0] focus:outline-none transition-all ${
                    inviteError
          ...
          {step === 'setup-command' && (
            <div className="flex flex-col">
              ...
              {/* Command box */}
              <div className="bg-[var(--app-card-bg)] border border-[var(--app-border)] rounded-[12px] overflow-hidden mb-4">
                {/* Timer header */}
          ...
          {step === 'success' && (
            <div ref={confettiRef} className="flex flex-col items-center relative">
              ...
              {/* Wallet ↔ Agent info */}
              <div className="w-full max-w-[420px] rounded-[12px] border border-[var(--app-border)] bg-[var(--app-card-bg)] overflow-hidden mb-8">
