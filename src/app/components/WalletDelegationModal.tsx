          ...
          <div className="p-5">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-[rgba(79,94,255,0.1)] flex items-center justify-center">
                <Shield className="w-5 h-5 text-[#4f5eff]" />
              </div>
              <div>
            ...
            {step === "success" ? (
              ...
              <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="w-20 bg-[#fafafa] border border-[rgba(10,10,10,0.12)] rounded-[6px] px-2 py-1.5 font-['Inter',sans-serif] text-[13px] text-[#0a0a0a] focus:outline-none focus:border-[#4f5eff]"
                        />
                      </div>
                    </div>
                    <div>
                ...
                <button
                  ...
                  className="w-full bg-[#4f5eff] hover:bg-[#3d4dd9] h-[40px] rounded-[8px] font-['Inter',sans-serif] font-medium text-[14px] text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="border-t border-[rgba(10,10,10,0.08)] pt-3">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-['Inter',sans-serif] font-medium text-[13px] text-[#4f5eff]">{t("walletDelegation.pairNew")}</div>
                      <div className="font-['Inter',sans-serif] font-normal text-[11px] text-[#7c7c7c]">{t("walletDelegation.pairNewDesc")}</div>
                    </div>
                    <ChevronRight className="w-4 h-4 text-[#4f5eff] flex-shrink-0" />
                  </button>
                </div>
              </div>
            )}
