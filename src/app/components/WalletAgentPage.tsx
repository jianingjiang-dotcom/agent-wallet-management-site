    ...
    <div className="max-w-[768px] mx-auto">
      {detailWallet ? (
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <div className="w-full max-w-lg bg-[var(--app-card-bg)] border border-[var(--app-border)] rounded-[16px] p-8 md:p-12 text-center">
            <div className="inline-flex items-center justify-center w-[72px] h-[72px] bg-gradient-to-br from-[rgba(79,94,255,0.12)] to-[rgba(79,94,255,0.04)] border-2 border-[rgba(79,94,255,0.15)] rounded-[16px] mb-6">
              <Shield className="w-9 h-9 text-[var(--app-accent)]" />
            </div>
            <h1 className="font-bold text-[28px] md:text-[32px] text-[var(--app-text)] mb-3 leading-tight">
              {t('welcome.greeting')}
            </h1>
            <p className="font-normal text-[15px] md:text-[16px] text-[var(--app-text-secondary)] mb-8 max-w-xl mx-auto leading-relaxed">
              {t('welcome.subtitle')}
            </p>
            <button
              onClick={onSetupWallet || noop}
              className="bg-[var(--app-accent)] hover:bg-[var(--app-accent-hover)] active:bg-[#2d3db9] text-white font-semibold text-[15px] px-8 py-3.5 rounded-[12px] transition-all shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_4px_12px_0px_rgba(79,94,255,0.2)] inline-flex items-center gap-2.5 hover:shadow-[0px_2px_6px_0px_rgba(0,0,0,0.12),0px_6px_20px_0px_rgba(79,94,255,0.28)]"
            >
              {t('welcome.cta')}
            ...
            <div className="mt-4">
              <button
                ...
                className="font-normal text-[13px] text-[var(--app-text-secondary)] hover:text-[var(--app-accent)] transition-colors inline-flex items-center gap-1.5"
              >
