        ...
        <div className="p-5">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-[rgba(79,94,255,0.1)] flex items-center justify-center">
              <Download className="w-5 h-5 text-[var(--app-accent)]" />
            </div>
            <div>
          ...
          {phase === "confirming" ? (
            <div>
              ...
              <div className="bg-[var(--app-card-bg)] border border-[var(--app-border)] rounded-[8px] px-4 py-3 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Wallet className="w-4 h-4 text-[var(--app-accent)]" />
                    <span className="font-medium text-[13px] text-[var(--app-text)]">
                      {t("claimWallet.walletId")}
                    </span>
                  </div>
                  <span className="font-['JetBrains_Mono',monospace] text-[12px] text-[var(--app-text-secondary)]">{walletId}</span>
                </div>
                <div className="border-t border-[rgba(10,10,10,0.06)]" />
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Bot className="w-4 h-4 text-[var(--app-accent)]" />
                    <span className="font-medium text-[13px] text-[var(--app-text)]">
                      {t("claimWallet.agentId")}
                    </span>
                  </div>
                  <span className="font-['JetBrains_Mono',monospace] text-[12px] text-[var(--app-text-secondary)]">{agentId}</span>
                </div>
              </div>
              ...
              <div className="flex gap-2 mt-4">
                <button
                  ...
                  className="flex-1 bg-[var(--app-bg)] hover:bg-[var(--app-hover-bg)] h-[40px] rounded-[8px] font-medium text-[13px] text-[var(--app-text-secondary)] transition-colors"
                >
                  {t("common.cancel")}
                </button>
                <button
                  onClick={handleConfirmClaim}
                  className="flex-1 bg-[var(--app-accent)] hover:bg-[var(--app-accent-hover)] h-[40px] rounded-[8px] font-medium text-[14px] text-white transition-colors"
                >
            ...
            <div className="text-center py-6">
              ...
              <div className="bg-[var(--app-card-bg)] border border-[var(--app-border)] rounded-[8px] px-4 py-3 mb-4 text-left space-y-2">
                <div>
                  <span className="font-normal text-[11px] text-[var(--app-text-secondary)]">{t("claimWallet.walletId")}</span>
                  <div className="font-['JetBrains_Mono',monospace] text-[11px] text-[var(--app-text)]">{walletId}</div>
                </div>
                <div>
                  <span className="font-normal text-[11px] text-[var(--app-text-secondary)]">{t("claimWallet.agentId")}</span>
                  <div className="font-['JetBrains_Mono',monospace] text-[11px] text-[var(--app-text)]">{agentId}</div>
                </div>
              </div>
              <button
                onClick={handleDone}
            ...
            <div>
              <div className="bg-[var(--app-card-bg)] border border-[var(--app-border)] rounded-[8px] mb-4 overflow-hidden">
                {/* Prompt text block */}
                <div className="bg-[var(--app-bg)] rounded-[8px]">
                  <div className="p-4">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 h-[40px] rounded-[8px] font-medium text-[14px] text-white transition-all shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)] ${
                  copied ? "bg-[#22c55e] hover:bg-[#16a34a]" : "bg-[var(--app-accent)] hover:bg-[var(--app-accent-hover)]"
                }`}
              >
                {copied ? (
