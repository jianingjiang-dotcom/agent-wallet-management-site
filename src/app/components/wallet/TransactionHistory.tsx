...
export default function TransactionHistory({ transactions, selectedChain, selectedAddress, walletAddresses }: TransactionHistoryProps) {
  const { t } = useLanguage();
          ...
          return (
            <div key={tx.id} className="flex items-center gap-3 py-3">
              ...
              <a
                ...
                className="shrink-0 p-1.5 rounded-[6px] text-[#b0b0b0] hover:text-[#4f5eff] hover:bg-[rgba(79,94,255,0.06)] transition-colors"
