...
const translations = {
  en: {
    ...
    // Pact
    "pact.approvalRequest": "Approval Request",
    "pact.specDetails": "Approval Details",
    ...
    "pact.chains": "Chains",
    "pact.tokens": "Tokens",
    "pact.targets": "Targets",
    "pact.walletId": "Wallet ID",
    ...
    "pact.executionPlan": "Execution Plan",
    "pact.condition.tx_count": "Max transactions",
    "pact.condition.total_amount_usd": "Total amount (USD)",
    "pact.condition.amount_spent_usd": "Amount spent (USD)",
    "pact.aiSummary": "AI Summary",
    "pact.originalChat": "Original Chat",
    "pact.structured": "Structured",
    "pact.rawData": "Raw Data",
    "pact.source": "Source",
    "pact.copyRaw": "Copy",
    "pact.copied": "Copied",
    "pact.permission.write:contract_call": "Write: Contract Call",
    "pact.permission.write:transfer": "Write: Transfer",
    "pact.permission.read:wallet": "Read: Wallet",
    "pact.policy.allow": "Allow",
    "pact.policy.deny": "Deny",
    "pact.banner.pendingPacts": "{n} pending approval{s}",
    "pact.banner.view": "View",
    "pact.banner.viewInChat": "View in Chat",
    "pact.modify.selectTitle": "What would you like to modify?",
    "pact.modify.adjustAmountLimit": "Adjust transaction amount limit",
    "pact.modify.adjust24hTxCount": "Adjust 24h transaction count limit",
    "pact.modify.adjust24hAmount": "Adjust 24h amount limit",
    "pact.modify.modifyPermissions": "Modify allowed operations",
    "pact.modify.changeTargets": "Change allowed contracts/chains",
    "pact.modify.shortenDuration": "Shorten duration",
    "pact.modify.adjustMaxTxCount": "Adjust max transaction count",
    ...
    "pact.modify.confirmApprove": "Confirm & Approve Modifications",
    "pact.modify.amountLimitLabel": "Amount Limit (USD)",
    "pact.modify.txCount24hLabel": "24h Transaction Count",
    "pact.modify.amountLimit24hLabel": "24h Amount Limit (USD)",
    "pact.modify.txCountMaxLabel": "Max Transactions",
    "pact.modify.durationLabel": "Duration",
    "pact.modify.permissionsLabel": "Permissions",
    "pact.modify.targetsLabel": "Contracts & Chains",
  ...
  zh: {
    ...
    // Pact
    "pact.approvalRequest": "审批请求",
    "pact.specDetails": "审批详情",
    "pact.permissions": "权限",
    "pact.policies": "策略规则",
    "pact.duration": "有效期",
    ...
    "pact.denyIf": "拒绝条件",
    "pact.reviewIf": "审核条件",
    "pact.executionPlan": "执行计划",
    "pact.condition.tx_count": "最大交易次数",
    "pact.condition.total_amount_usd": "累计金额 (USD)",
    "pact.condition.amount_spent_usd": "累计消费 (USD)",
    "pact.aiSummary": "AI 摘要",
    "pact.originalChat": "原始对话",
    "pact.structured": "结构化",
    "pact.rawData": "原始数据",
    "pact.source": "来源",
    "pact.copyRaw": "复制",
    "pact.copied": "已复制",
    "pact.permission.write:contract_call": "写入: 合约调用",
    "pact.permission.write:transfer": "写入: 转账",
    "pact.permission.read:wallet": "读取: 钱包",
    "pact.policy.allow": "允许",
    "pact.policy.deny": "拒绝",
    "pact.banner.pendingPacts": "{n} 条审批待处理",
    "pact.banner.view": "查看",
    "pact.banner.viewInChat": "在聊天中查看",
    "pact.modify.selectTitle": "你想修改哪些内容？",
    "pact.modify.adjustAmountLimit": "调整交易金额限制",
    "pact.modify.adjust24hTxCount": "调整 24h 交易次数限制",
    "pact.modify.adjust24hAmount": "调整 24h 累计金额限制",
    "pact.modify.modifyPermissions": "修改允许的操作类型",
    "pact.modify.changeTargets": "修改目标合约/链范围",
    "pact.modify.shortenDuration": "缩短有效期",
    "pact.modify.adjustMaxTxCount": "调整最大交易次数",
    ...
    "pact.modify.confirmApprove": "确认并批准修改",
    "pact.modify.amountLimitLabel": "交易金额限制 (USD)",
    "pact.modify.txCount24hLabel": "24h 交易次数",
    "pact.modify.amountLimit24hLabel": "24h 累计金额 (USD)",
    "pact.modify.txCountMaxLabel": "最大交易次数",
    "pact.modify.durationLabel": "有效期",
    "pact.modify.permissionsLabel": "权限",
    "pact.modify.targetsLabel": "合约与链",
