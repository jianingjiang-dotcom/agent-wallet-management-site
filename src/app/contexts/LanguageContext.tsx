...
const translations = {
  en: {
    ...
    "account.connectedAccountsDesc": "Manage the accounts linked for sign-in. At least one must remain connected.",
    "account.dangerZone": "Sign Out",
    "account.secureTitle": "Secure your account",
    "account.secureDesc": "Add a backup sign-in method so you're never locked out.",
    "account.secureAction": "Connect a backup",
    "account.secureDismiss": "Dismiss",
    "account.unbindTitle": "Remove sign-in method?",
    "account.unbindDesc": "You won't be able to use {provider} to sign in anymore. Make sure your other method is working.",
    "account.unbindConfirm": "Remove",
    "account.signOutTitle": "Sign out of CoboAgenticWallet?",
    "account.signOutDesc": "You'll need to sign in again to access your wallets and agent settings.",
    "account.signOutConfirm": "Sign Out",
    "account.loginMethod": "Used to sign in",
  ...
  zh: {
    ...
    "account.editName": "编辑姓名",
    "account.save": "保存",
    "account.cancel": "取消",
    "account.memberSince": "注册于",
    "account.connectedAccounts": "关联账号",
    "account.connectedAccountsDesc": "管理用于登录的关联账号，至少需保留一个。",
    "account.dangerZone": "退出登录",
    "account.secureTitle": "保护您的账户",
    "account.secureDesc": "添加备用登录方式，防止账户被锁定。",
    "account.secureAction": "立即绑定",
    "account.secureDismiss": "忽略",
    "account.unbindTitle": "移除登录方式？",
    "account.unbindDesc": "解绑后将无法再使用 {provider} 登录。请确保您的其他登录方式可正常使用。",
    "account.unbindConfirm": "确认移除",
    "account.signOutTitle": "退出 CoboAgenticWallet？",
    "account.signOutDesc": "退出后需要重新登录才能访问您的钱包和 Agent 设置。",
    "account.signOutConfirm": "退出登录",
    "account.loginMethod": "用于登录",
